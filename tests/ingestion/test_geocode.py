...
from ingestion.geocode import CensusAddressMatch, GeocodeIngester, compact_geocode_query
...
async def test_fetch_falls_back_to_photon_when_census_returns_no_matches() -> None:
    ...
    signals = await FallbackIngester().fetch(LocationInput(address="501 OFARRELL ST, SAN FRANCISCO, CA, 94102"))
