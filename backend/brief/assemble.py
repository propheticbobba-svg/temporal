...
from ..store import Location, Signal
from .anomalies import refine_anomalies
from .classify import PlaceClassification, classify_place
from .graph import build_place_graph
from .models import Brief, BriefCategoryName, BriefModule, BriefRequest, CategoryBrief, SignalRead
...
def build_brief(session: Session, request: BriefRequest) -> Brief:
    ...
    return Brief(
        ...
        anomaly_flags=refine_anomalies(reads),
